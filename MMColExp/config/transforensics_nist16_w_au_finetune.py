...
data = dict(
    ...
    train=dict(
            ...
            # data_root='/mnt/disk1/image_forgery/nist16/nist16',
            ann_path='nist16_w_au_mul_cates_train.txt',
    ...
    val=[
        ...
        dict(
            ...
            # data_root='/home/yangwu/data/image_forgery/nist16/nist16',
            # data_root='/mnt/disk1/image_forgery/nist16/nist16',
            ann_path='nist16_w_au_mul_cates_val.txt',
            test_mode=True,
            pipeline=test_pipeline,
            dataset_name='nist16',
            gt_seg_map_loader_cfg=dict(
        ...
        #     # data_root='/mnt/disk1/image_forgery/IMD20/real_life',
        #     ann_path='IMD20_val.txt',
        #     test_mode=True,
        #     pipeline=test_pipeline,
        #     dataset_name='IMD20',
        #     gt_seg_map_loader_cfg=dict(
        ...
        #     # data_root='/mnt/disk1/image_forgery/COVERAGE',
        ...
        #     # data_root = '/mnt/disk1/image_forgery/tianchi_text_forgory',
        #     ann_path='val.txt',
        #     test_mode=True,
        #     pipeline=test_pipeline,
...
model = dict(
    ...
    type='TransForensicsDetector_v2',
    base_model=dict(
        type='TransForensics_v4',
        # out_layer=2,
        out_layer=1,
        # f_dims=[256, 512, 1024, 2048],
        f_dims=[64, 128, 320, 512],
    ...
    train_cfg=dict(
        ...
        seg_loss_weights=[0.5, 0.3, 0.2],
        # ran_loss_weights=[0.4, 0.3, 0.3],
        ran_loss_weights=[0.6, 0.2, 0.2],
        # ran_loss_weights=[0.8, 0.1, 0.1],
        clf_loss=dict(
            type='CrossEntropyLoss',
            use_sigmoid=True,
            loss_weight=1.0,

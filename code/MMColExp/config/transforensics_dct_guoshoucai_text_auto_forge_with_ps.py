...
data = dict(
    ...
    val=[
        dict(
            type=dataset_type,
            data_root='/mnt/disk1/data/image_forgery/text_forgery/guoshoucai_auto_gen/test_forged_with_ps',
            # ann_path='test.txt',
            ann_path='test_1.txt',
            test_mode=True,
        ...
        dict(
            type=dataset_type,
            data_root='/mnt/disk1/data/image_forgery/text_forgery/tianchi_text_forgory',
            ann_path='val.txt',
            test_mode=True,
            pipeline=test_pipeline,
